...
class Entity ( GameSprite ):
	...
	def __move_x_wise ( self, dt: float ):
		self.hitbox.x += self.direction.x * self.speed * dt

	def __move_y_wise ( self, dt: float ):
		self.hitbox.y += self.direction.y * self.speed * dt

	def __x_collision_manager ( self, collision_sprites: Group ):
	...
	def __y_collision_manager ( self, collision_sprites: Group ):
		for sprite in collision_sprites:
			if sprite.rect.colliderect(self.hitbox):
	...
	def _manage_collision ( self, collision_sprites: Group, dt: float ):
		self.__move_x_wise(dt)
		self.__x_collision_manager(collision_sprites)
		self.__move_y_wise(dt)
		self.__y_collision_manager(collision_sprites)
